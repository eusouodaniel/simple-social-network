$(document).on "turbolinks:load", ->
  ...
  $('body').on 'ajax:error', '.delete_post', (e, data, status, xhr) ->
    Materialize.toast('Problema ao deletar post', 4000, 'red')